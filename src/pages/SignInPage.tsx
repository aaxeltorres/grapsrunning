    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-100 via-stone-100 to-stone-300">
      ...
      <section className="py-20 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          {/* Box con borde degradado */}
          <div className="w-full bg-gradient-to-r from-cyan-300 to-blue-500 rounded-3xl p-[1px] shadow-lg">
            <div className="bg-white rounded-3xl p-8">
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <button onClick={() => navigate("/joinus")} className="text-cyan-600 hover:text-cyan-500 font-medium">
                    Join Us
                  </button>
                </p>
              </div>
